...
import { Grid, TextField, Select, MenuItem, FormControl, Typography, Button, Box } from '@mui/material';
import OutlinedInput from '@mui/material/OutlinedInput';
import { CreateProductAPI } from '../../../../api/product/ProductController';
    ...
    const fetchDropdownData = async () => {
      ...
      try {
        const categoriesResponse = await fetch(
          process.env.REACT_APP_UAT_RESOURCE_ENDPOINT + "Category.json?t=" + timestamp
        );
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {isLoading ? "Submitting..." : steps > 1 ? "Next" : "Submit"}
        </Button>
      </Box>
    </Grid>
  );
...
export default ProductEditDialogForm;
